  ...
  return (
    <div className="min-h-screen bg-surface">
      <div className="max-w-4xl mx-auto px-6 py-12">
        <h1 className="text-3xl font-bold mb-6 text-text-main">Privacy Policy</h1>
        <div className="card p-8 space-y-6 text-text-muted">
          <p>Last updated: {new Date().toLocaleDateString()}</p>
          
          <section>
            <h2 className="text-xl font-semibold mb-3 text-text-main">1. Information We Collect</h2>
          ...
          <section>
            <h2 className="text-xl font-semibold mb-3 text-text-main">2. How We Use Information</h2>
          ...
          <section>
            <h2 className="text-xl font-semibold mb-3 text-text-main">3. Data Security</h2>
          ...
          <section>
            <h2 className="text-xl font-semibold mb-3 text-text-main">4. Cookies</h2>
          ...
          <section>
            <h2 className="text-xl font-semibold mb-3 text-text-main">5. Changes to This Policy</h2>
