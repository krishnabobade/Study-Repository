...
export default function Browse() {
  ...
  const clearFilters = () => { setFilters({ course: '', semester: '', category: '', fileType: '' }); setSearch(''); setPage(1) }
    ...
    <div className="p-6 max-w-7xl mx-auto">
      ...
      <div className="flex gap-3 mb-4">
        ...
        <button onClick={() => setShowFilters(f => !f)}
          className={`btn-ghost border ${showFilters ? 'border-ink-500/50 text-ink-300' : 'border-border'}`}>
