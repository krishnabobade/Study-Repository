...
import { Lock, ArrowLeft, BookOpen, CheckCircle } from 'lucide-react';
        ...
        >
          ...
          {success ? (
            ...
            >
              ...
              <Link
                to="/login"
                className="w-full py-3 bg-ink-600 hover:bg-ink-700 text-white rounded-xl font-medium transition-colors flex justify-center items-center"
              >
                Go to Login
              </Link>
            </motion.div>
