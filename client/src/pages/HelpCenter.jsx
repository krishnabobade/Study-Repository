...
const faqsData = [
  ...
  // Admin
  { category: 'For Admin', question: 'How do I approve or reject uploads?', answer: 'Access the "Pending Approvals" dashboard. Review the document content and academic details, then click Approve or Reject.' },
  { category: 'For Admin', question: 'How do I manage users?', answer: 'Navigate to the "User Management" section to view all registered users, change roles, or suspend accounts if necessary.' },
  { category: 'For Admin', question: 'How do I view reports and analytics?', answer: 'The main admin dashboard provides real-time statistics on total users, daily uploads, storage usage, and engagement metrics.' },
  { category: 'For Admin', question: 'How do I handle reported issues?', answer: 'Go to the "User Feedback" or "Bug Reports" section to review tickets submitted by users and take appropriate action.' },
  ...
  // General
  { category: 'General / Technical', question: 'Which browsers are supported?', answer: 'We support all modern browsers including Google Chrome, Mozilla Firefox, Safari, and Microsoft Edge.' },
  { category: 'General / Technical', question: 'Why is the website slow sometimes?', answer: 'Heavy traffic during exam seasons might cause slight delays. We continuously monitor and scale our servers to minimize this.' },
  { category: 'General / Technical', question: 'What should I do if something is not working?', answer: 'Try refreshing the page or clearing your browser cache. If the issue persists, submit a bug report via the sidebar.' },
  { category: 'General / Technical', question: 'How can I contact support?', answer: 'You can email our emergency support team or use the Contact Support button at the bottom of this page.' },
];
  ...
  return (
    <div className="p-4 sm:p-6 lg:p-10 max-w-5xl mx-auto w-full">
      ...
      <div className="mb-10 text-center">
        <h1 className="text-3xl sm:text-4xl font-bold mb-4 text-text-main">How can we help you?</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        >
          ...
          <a 
            href="#faqs" 
            onClick={(e) => handleScroll(e, 'faqs')}
            className="text-sm font-medium text-blue-500 hover:text-blue-400 transition-colors mt-auto"
          >
            Browse FAQs &rarr;
          </a>
        </motion.div>
