          ...
          <table className="w-full text-left border-collapse">
            <thead>
              <tr className="bg-surface/50 border-b border-border">
                <th className="px-6 py-4 text-xs font-bold uppercase tracking-wider text-text-muted w-1/4">Action</th>
                <th className="px-6 py-4 text-xs font-bold uppercase tracking-wider text-text-muted w-1/4">Performed By</th>
                <th className="px-6 py-4 text-xs font-bold uppercase tracking-wider text-text-muted w-1/4">Target / Detail</th>
                <th className="px-6 py-4 text-xs font-bold uppercase tracking-wider text-text-muted w-1/4 text-right">Timestamp</th>
              </tr>
            </thead>
            <tbody className="divide-y divide-border">
              {loading ? (
                ...
                <tr>
                  <td colSpan="4" className="px-6 py-12 text-center text-text-muted">No logs found.</td>
                </tr>
